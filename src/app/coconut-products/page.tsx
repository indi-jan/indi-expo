...
import { coconutProducts } from '@/lib/coconut-products';
import { Card, CardContent, CardHeader, CardTitle } from '@/components/ui/card';

export default function CoconutProductsPage() {
      ...
      >
        <div className="container mx-auto px-4">
          <motion.p variants={fadeIn} className="text-center text-lg text-muted-foreground max-w-3xl mx-auto mb-12">
            From the tropical groves of India, we bring you a range of pure and natural coconut products. Our selection is perfect for culinary uses, offering authentic taste and wholesome goodness.
          </motion.p>
