...
export default function PulsesPage() {
  const heroImage = PlaceHolderImages.find(p => p.id === 'pulses-hero');
      ...
      >
        <div className="container mx-auto px-4">
          <motion.p variants={fadeIn} className="text-center text-lg text-muted-foreground max-w-3xl mx-auto mb-12">
            Discover our range of high-quality pulses, sourced from the best farms in India. Packed with protein and essential nutrients, our pulses are a cornerstone of healthy and flavorful meals.
          </motion.p>
